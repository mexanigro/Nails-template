      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div className="space-y-12">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
               <div className="space-y-4">
                  ...
                  <a 
                    ...
                    className="inline-flex items-center gap-2 text-[10px] font-black uppercase tracking-widest text-amber-500 hover:text-white transition-colors group"
                  >
               ...
               <div className="space-y-2">
                  ...
                  <div className="flex flex-col gap-1">
                    <a href={`tel:${contact.phone}`} className="text-zinc-500 dark:text-zinc-400 transition-colors duration-300 text-sm hover:text-amber-500 transition-colors">
                       Phone: {contact.phone}
                    </a>
                    <a href={`mailto:${contact.email}`} className="text-zinc-500 dark:text-zinc-400 transition-colors duration-300 text-sm hover:text-amber-500 transition-colors">
                       Email: {contact.email}
                    </a>
                  </div>
               </div>
            ...
            <div className="p-8 bg-zinc-50 dark:bg-zinc-950 transition-colors duration-300 border border-zinc-200 dark:border-zinc-800 transition-colors duration-300 rounded-3xl space-y-4">
          ...
          <div className="relative">
            ...
            >
              ...
              <div className="absolute inset-0 bg-zinc-100 dark:bg-zinc-800 transition-colors duration-300 flex items-center justify-center p-12 text-center text-zinc-900 dark:text-zinc-100 transition-colors duration-300">
                 <div className="space-y-4">
                    <MapPin size={48} className="text-amber-500 mx-auto" />

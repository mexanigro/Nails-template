...
export function Gallery({ onViewFull }: { onViewFull: () => void }) {
  ...
  return (
    <section id="gallery" className="py-24 bg-zinc-50 dark:bg-zinc-950 transition-colors duration-300 px-6">
      <div className="max-w-7xl mx-auto text-center">
        ...
        <motion.button
          ...
          viewport={{ once: true }}
          onClick={onViewFull}
          className="group relative inline-flex items-center gap-4 bg-white dark:bg-zinc-900 transition-colors duration-300 border border-zinc-200 dark:border-zinc-800 transition-colors duration-300 hover:border-amber-500 hover:bg-zinc-100 dark:bg-zinc-800 transition-colors duration-300 text-zinc-950 dark:text-white px-10 py-5 rounded-2xl font-black uppercase tracking-[0.2em] transition-all overflow-hidden"
        >
          <LayoutGrid size={20} className="text-amber-500 group-hover:scale-125 transition-transform" />

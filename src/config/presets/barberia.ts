...
export const barberiaPreset: NichePreset = {
  ...
  brand: {
    ...
    aiPersona:
      "Eres un asistente virtual experto en barbería de lujo. Tu objetivo es ayudar a los clientes, responder sus dudas de forma breve y recomendar nuestros servicios de grooming.",
  },
  ...
  hero: {
    ...
    subtitle:
      "Experience the pinnacle of sophisticated grooming. Where tradition meets high-precision artistry.",
    ctaPrimary: "RESERVE YOUR CHAIR",
    ctaSecondary: "OUR SERVICES",
    backgroundImage:
      "https://images.unsplash.com/photo-1503951914875-452162b0f3f1?auto=format&fit=crop&q=80&w=2000",
  },
  ...
  services: [
    ...
    },
    {
      ...
      description:
        "Expert shaping and line-up with premium beard oil treatment.",
      duration: 20,
      price: 30,
    },
    {
    ...
    },
    {
      ...
      description:
        "Traditional hot lather shave for skin as smooth as steel.",
      duration: 30,
      price: 40,
    },
  ],
  ...
  sections: {
    ...
    team: {
      ...
      description:
        "Our roster consists of multi-disciplined artists, hand-selected for their technical precision and commitment to the architectural integrity of the modern male silhouette.",
    },
    whyChooseUs: {
      title: "The Standard",
      subtitle: "Why Choose Us",
      mainImage:
        "https://images.unsplash.com/photo-1542646351-4122d21a2886?auto=format&fit=crop&q=80&w=1000",
      badge: "10 Years\nOf Mastery",
      benefits: [
        {
    ...
    contact: {
      ...
      description:
        "Have a special request or a question? Drop us a line and the team will get back to you shortly.",
    },
    booking: {
      ...
      aiConsultant: {
        ...
        placeholder:
          "Describe your vision (e.g. 'Tactical low-fade with beard sync')...",
      },
      success: {
        title: "Success",
        confirmed: "Confirmed!",
    ...
    admin: {
      staff: {
        ...
        enforcementDesc:
          "Personnel schedules are strictly enforced by the booking core. Any changes to weekly windows or inactive days will instantly propagate to the frontend terminal, preventing impossible mission allocations.",
      },
    },
  },
};
